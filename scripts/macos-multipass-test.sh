...
echo "Start a multipass instance, 2 CPU, 4GB Ram, 30GB Disk, Noble Image."
echo
...
sudo cp /var/root/Library/Application\ Support/multipassd/ssh-keys/id_rsa "$HOME/id_rsa"
